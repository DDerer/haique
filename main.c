...
int main()
{
    ...
    TIM3_Config();
	Encoder_Init();
	PID_Init(&motor_pid[0], 0.2f, 0.8f, 0.7f,0);  // 电机1
	PID_Init(&motor_pid[1], 0.2f, 0.8f, 0.7f,0);  // 电机2  
	PID_Init(&motor_pid[2], 0.2f, 0.8f, 0.7f,0);  // 电机3	
	while(1)
	{	
//		Move_round();
//		Move_Triangle();
